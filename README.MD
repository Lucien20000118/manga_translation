...
在 page_adjust.py 中實作了嚴格的 Inspector Lock。當未選取文字框時，所有編輯工具（文字、大小、顏色）會強制鎖定 (Disabled) 並套用系統級安全預設值，徹底解決了舊版 UI 的「幽靈狀態 (Ghost State)」與潛在的 Type Crash (如錯誤解析 #ZZZZZZ)。
